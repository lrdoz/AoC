...
def user_session(cookie=cookie):
    """Starts a session for AoC so I can programmatically get the input for the 
    quizzes
        cookie (str, optional): Defaults to cookie (you need to get this from your browser,
        make sure to not commit this to GitHub)
    
    Raises:
        ValueError: you did not provide a cookie
...
class puzzle_data(object):
    ...
    def get_data(self):
        ...
        if self.temp is None:
            ...
            if response.status_code == requests.codes.ok:
                ...
                raise IOError(
                    "Ooops that did not work, got a {} code: {}".format(
    ...
    def submit(self, part, answer):
        ...
        if ("That's the right answer!") in content:
            ...
            print(
                "Wrong answer! your answer is: ",
                content.split("your answer is ")[1].split(".", 1)[0],
            )
        else:
